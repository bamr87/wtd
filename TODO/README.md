...
This directory contains active TODO items for the WTD project.

## Active Tasks

- [ ] Set up Ollama with llama3.2 model for local AI
- [ ] Add GitHub issues integration for scanning remote TODOs
